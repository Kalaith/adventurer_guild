...
export const initialFactions: Faction[] = [
  {
    ...
    reputation: 0,
    description:
      "A powerful organization of traders and merchants who control much of the region's commerce.",
    questModifiers: {
  ...
  },
  {
    ...
    reputation: 0,
    description:
      'A religious organization dedicated to fighting darkness and evil throughout the land.',
    questModifiers: {
  ...
  },
  {
    ...
    reputation: 0,
    description:
      'The elite military force serving the crown, often requesting assistance with matters of national security.',
    questModifiers: {
  ...
  },
  {
    ...
    reputation: 0,
    description:
      'An ancient order of wizards and scholars dedicated to the study and preservation of magical knowledge.',
    questModifiers: {
      rewardMultiplier: 1.25,
      availableQuestTypes: [
        'magical_research',
        'artifact_recovery',
        'spell_component_gathering',
        'arcane_study',
      ],
    },
  },
  {
    ...
    reputation: 0,
    description:
      'A secretive organization of rogues and information brokers who operate in the shadows.',
    questModifiers: {
  ...
  },
  {
    ...
    reputation: 0,
    description:
      'Guardians of nature who seek to maintain the balance between civilization and the wild.',
    questModifiers: {
  ...
  },
  {
    ...
    reputation: 0,
    description:
      'A confederation of skilled craftspeople who create the finest weapons, armor, and tools.',
    questModifiers: {
      rewardMultiplier: 1.1,
      availableQuestTypes: [
        'material_gathering',
  ...
  },
  {
    ...
    reputation: 0,
    description:
      'Hardy folk who dwell in the high peaks and valleys, known for their mining expertise and warrior traditions.',
    questModifiers: {
      rewardMultiplier: 1.2,
